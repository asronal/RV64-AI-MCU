...
module rv64_ai_soc_top (
  ...
  wire uart_tx, spi_sclk, spi_mosi, i2c_scl, i2c_sda;
  wire pwm_out, pwm_irq;
  wire adc_usb_tx, can_tx;
  wire plic_irq, plic_debug_halt;
  wire qspi_cs, psram_cs;
  wire qspi_dma_irq;
  wire [7:0] dma_sg_irq;
  wire sec_secure_boot_ok, sec_otp_ready, sec_trng_ready;
  wire brk_hw_breakpoint, brk_watchpoint;
  wire clk_sleep_mode, clk_deep_sleep, clk_wake_irq;
  wire [31:0] crypto_status;
  wire jtag_tms, jtag_tdi, jtag_tck;
  wire [31:0] perf0, perf1, perf2, perf3;
  wire [31:0] pmp_cfg;
  wire [31:0] trace_word;
  wire usb_tx, usb_rx;
  wire dbg_debug_halt;
  wire [31:0] trace_buf;
  wire spi2_sclk, spi2_mosi;
  wire uart2_tx;
  ...
  wire        mem_read  = core_dmem_read | core_imem_read;
  ...
  generate
    if (1) begin : gen_peripherals
      ...
      rv64_ai_security_block u_sec (
        ...
        .secure_boot_ok(sec_secure_boot_ok),
        .otp_ready(sec_otp_ready),
        .trng_ready(sec_trng_ready)
      );
      ...
      rv64_ai_breakpoint_unit u_brk (
        ...
        .hw_breakpoint(brk_hw_breakpoint),
        .watchpoint(brk_watchpoint)
      );
      ...
      rv64_ai_clock_sleep_wakeup u_clk (
        ...
        .sleep_mode(clk_sleep_mode),
        .deep_sleep(clk_deep_sleep),
        .wake_irq(clk_wake_irq)
      );
