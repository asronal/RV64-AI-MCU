...
module rv64_ai_dma_sg (
  ...
  assign chan_sel = ((axil_addr[7:0] - 8'h10) >> 2);
  ...
  assign axil_rdata = (axil_addr[7:0] == 8'h00) ? ctrl_reg :
                      (axil_addr[7:0] >= 8'h10 && axil_addr[7:0] < 8'h30) ? chan_reg[chan_sel] : 32'b0;
