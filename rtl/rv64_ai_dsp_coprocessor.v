...
module rv64_ai_dsp_coprocessor (
  ...
  localparam [7:0] CMD_REG = 8'h08;
  localparam [7:0] SIMD_REG = 8'h10;
  ...
  assign simd_vec_a = {simd_reg, simd_reg, simd_reg, simd_reg};
  assign simd_vec_b = {cmd_reg, cmd_reg, cmd_reg, cmd_reg};
endmodule
