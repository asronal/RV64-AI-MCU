    ...
    case (mode)
      2'd0: begin // int8 x4 MAC
        acc_out = {128'b0,
                   ...
                   data_a[63:32] * data_b[63:32],
                   data_a[95:64] * data_b[95:64],
                   data_a[127:96] * data_b[127:96]};
      end
      2'd1: begin // int16 x2 MAC
        acc_out = {128'b0,
                   data_a[63:0] * data_b[63:0],
                   data_a[127:64] * data_b[127:64]};
      end
      2'd2: begin // int32 x1 MAC
        acc_out = {192'b0, data_a[63:0] * data_b[63:0]};
      end
